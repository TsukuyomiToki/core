...
//    , m_kwinTimer(new QTimer(this))
{
    ...
    QDBusConnection::sessionBus().registerService(QStringLiteral("com.pisces.Settings"));
...
//    m_kwinTimer->start();
    ...
    // Translations
    QLocale locale;
    QString qmFilePath = QString("%1/%2.qm").arg("/usr/share/pisces-settings-daemon/translations/").arg(locale.name());
...
void Application::invokeDesktopProcess()
{
    ...
    QDBusInterface sessionInterface("com.pisces.Session", "/Session", "com.pisces.Session",
...
//        effect.call("loadEffect", "pisces_popups");
//        effect.call("loadEffect", "pisces_scale");
//        effect.call("loadEffect", "pisces_squash");
